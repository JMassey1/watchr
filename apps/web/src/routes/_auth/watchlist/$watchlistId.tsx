						...
						{filteredItems.map((item) => (
							...
							>
								<div className="relative aspect-[16/10] overflow-hidden">
									...
									<span className="absolute left-3 top-3 inline-flex items-center gap-1 rounded-full bg-card/90 px-2.5 py-1 text-xs font-semibold capitalize text-card-foreground backdrop-blur-sm">
										{item.kind}
									</span>
									{item.watched && (
										<span className="absolute right-3 top-3 inline-flex items-center gap-1 rounded-full bg-primary px-2.5 py-1 text-xs font-semibold text-primary-foreground backdrop-blur-sm">
